...
/* package sudoku-server-0.1.0.0 */
#define VERSION_sudoku_server "0.1.0.0"
#define MIN_VERSION_sudoku_server(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "sudoku-server-0.1.0.0"

#define CURRENT_PACKAGE_KEY "sudoku-server-0.1.0.0"
