...
/* package Haskell-Sudoku-Solver-0.1.0.0 */
#define VERSION_Haskell_Sudoku_Solver "0.1.0.0"
#define MIN_VERSION_Haskell_Sudoku_Solver(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "Haskell-Sudoku-Solver-0.1.0.0"

#define CURRENT_PACKAGE_KEY "Haskell-Sudoku-Solver-0.1.0.0"
